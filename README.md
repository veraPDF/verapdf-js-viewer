...
|treeBboxSelectionMode|String that determines how tree bboxes are highlighted:<ul><li>The value "current" selects only the current bbox</li><li>The value "all" selects the current bbox and all child bboxes</li></ul> |current| One of the following values: <ul><li>`"current"`</li><li>`"all"`</li></ul>                                                                                  
