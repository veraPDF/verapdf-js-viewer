...
|bboxes|Array of bboxes`{page, location}` that will be rendered as selectable rectangles over pdf pages.<br />Currently support these locations:<br /><ul><li>Array of coordinates: `[x, y, width, height]`</li><li>String with coordinates for left-bottom point and top-right:`pages[1-2]/boundingBox[x,y,x2,y2]`</li><li>String path through tagged structure tree: `root/document[0]/pages[1](1 0 obj PDPage)/annots[1](100 0 obj PDLinkAnnot)`</li></ul> New contexts will be added.|n/a|`[{  page: 1, location: [10,200,300,440], page: 2, location: 'pages[2-4]/boundingBox[10,200,300,400]' }]`|
