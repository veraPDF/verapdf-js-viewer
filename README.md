...
|bboxes|Array of bboxes`{page, location}` that will be rendered as selectable rectangles over pdf pages.<br />Currently support these locations:<br /><ul><li>Array of coordinates: `[x, y, width, height]`</li><li>String with coordinates for left-bottom point and top-right:`pages[1-2]/boundingBox[x,y,x2,y2]`</li></ul> New contexts will be added.|n/a|`[{  page: 1, location: [10,200,300,440], page: 2, location: 'pages[2-4]/boundingBox[10,200,300,400]' }]`|
